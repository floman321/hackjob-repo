...
public class DBController extends SQLiteOpenHelper
{
	...
	public void deleteMeeting(String id)
	{
		...
		//ADDED TO DELETE ALL FILES ASSOCIATED WITH MEETING AS WELL.
		String deleteFileQuery = "DELETE FROM meetingfiles where fileMeetingRef='" + id + "'";
		database.execSQL(deleteFileQuery);
	}
	...
	// returns specific meetingid by name
		public HashMap<String, String> getMeeting(String name)
		{
			ArrayList<HashMap<String, String>> wordList;
			HashMap<String, String> map = new HashMap<String, String>();
			wordList = new ArrayList<HashMap<String, String>>();
			String selectQuery = "SELECT  * FROM meeting WHERE meetingName ='" + name + "'";
			SQLiteDatabase database = this.getWritableDatabase();
			Cursor cursor = database.rawQuery(selectQuery, null);
			if (cursor.moveToFirst())
			{
